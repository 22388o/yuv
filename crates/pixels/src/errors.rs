...
use bitcoin::{secp256k1, EcdsaSigError, PublicKey, Script};
...
pub enum PixelKeyError {
    ...
    PublicKeyError(bitcoin::util::key::Error),
    UncompressedKey,
}
...
impl From<bitcoin::util::key::Error> for PixelKeyError {
...
pub enum LightningCommitmentProofError {
    ...
    RedeemScriptMismatch { expected: Script, found: Script },
    MismatchScriptPubkey { expected: Script, found: Script },
}
...
impl From<bitcoin::util::key::Error> for P2WPKHWitnessParseError {
    fn from(err: bitcoin::util::key::Error) -> Self {
