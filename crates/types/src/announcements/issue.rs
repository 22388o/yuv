...
/// The two bytes that represents the [`issue announcement`]'s kind.
///
/// [`issue announcement`]: IssueAnnouncement
    ...
    fn test_backward_compatibility() {
        ...
        let valid_announcements = vec![
            TestData {
                ...
                script: Script::from_hex("6a3579757600027180bca3e852eaf905969d2507462498a019c3efd5444b72a4291b72b4dd26cc10270000000000000000000000000000").unwrap(),
            },
            TestData {
                ...
                script: Script::from_hex("6a3579757600027180bca3e852eaf905969d2507462498a019c3efd5444b72a4291b72b4dd26ccffffffffffffffffffffffffffffffff").unwrap(),
            },
        ];
