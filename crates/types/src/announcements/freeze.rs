...
/// The two bytes that represents the [`freeze announcement`]'s kind.
///
...
mod test {
    ...
    fn test_backward_compatibility() {
        ...
        let valid_announcement_script = Script::from_hex("6a297975760001bc0a00000000000000000000000000000000000000000000000000000000c0ab00000022").unwrap();
